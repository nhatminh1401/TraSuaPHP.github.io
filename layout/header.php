...
function dangnhap()
{
	if (isset($_SESSION["nguoidung"])) {
		echo '<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown">' . $_SESSION["nguoidung"][3] . '</a>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbars-rs-food">
				...
				<a href="cart.php" class="nav-item nav-link">
					...
					<span class="icon-shopping-cart" style="color: black;"></span><span class="badge badge-warning"> </span></a>
				<ul class="navbar-nav ml-auto">
					<li class="nav-item">
						<?php dangnhap(); ?>
					</li>
