        ...
        <table class="table table-bordered table-striped">
            ...
            foreach ($tbLoai as $row):
                ...
                <tr>
                    ...
                    <td>
                        <a href="index.php?quanly=loaisp&ac=sua&id=<?php echo $row['maLoaiSanPham'] ?>" class="btn btn-default">
                            <center>
                    ...
                    <td>
                        <a href="modules/quanlyloaisp/xuly.php?id=<?php echo $row['maLoaiSanPham'] ?>" class="btn btn-default">
                            <center>
