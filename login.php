...
<head>
	...
	<style>
		...
		html,
		body {
			background-image: url('https://img5.thuthuatphanmem.vn/uploads/2021/09/10/background-tra-sua-dep_043452447.jpg');
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<form action="XulyLogin.php" method="POST">
						...
						<a style="color: red;">
							<?php if (isset($_SESSION["thongbaodn"])) {
								echo $_SESSION["thongbaodn"];
